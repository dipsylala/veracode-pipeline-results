...
Unlike [https://github.com/dipsylala/veracode-skills](https://github.com/dipsylala/veracode-skills) it does not require an MCP server, and processes the JSON files generated by the Veracode Pipeline scan.
